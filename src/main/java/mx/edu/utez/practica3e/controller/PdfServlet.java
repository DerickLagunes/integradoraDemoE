    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        FileInputStream archivo = new FileInputStream(
                req.getSession().getServletContext().
                        getResource("/img/Logo.gif").getFile());

        //Obtener ubicación y bytes del reporte
        String report = "/WEB-INF/reporteE.jasper";
        ...
        resp.setHeader("Content-Disposition", "Attachment; filename=reporteE.pdf");  //esto es para forzar la descarga del archivo
